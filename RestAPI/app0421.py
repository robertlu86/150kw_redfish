...
managers_cdu_data =    {
    ...
    "UUID": "00000000-0000-0000-0000-e45f013e98f8",
    "Model": "Joo Janta 200",
    "DateTime": "2025/02/21 06:02:08",
    "DateTimeLocalOffset": "+0:00",
...
class MetricReports_1(Resource):
    def get(self):
        # 每次執行時清空 MetricValues，避免重複資料
        MetricReports_example_data["MetricValues"] = []
