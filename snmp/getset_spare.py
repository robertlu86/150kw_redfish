...
warning_alert_list = [
    [
        ...
        "M110 Filter Outlet Pressure Over Range (High) Warning (P4)",
    ...
    [
        ...
        "M210 Filter Outlet Pressure Over Range (High) Alert (P4)",
        ...
        if cnt > 5:
            try:
                with ModbusTcpClient(
                    ...
                    Mbus_DArr = client.read_holding_registers(5000, sensor_reg)
